...
新增包：`src/main/java/com/lyhn/wraith/snapshot/`
...
```text
~/.wraith-cli/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dwraith-cli.snapshot.enabled=false
-Dwraith-cli.snapshot.max=50
-Dwraith-cli.snapshot.excludes=...
```
