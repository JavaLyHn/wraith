...
interface SidebarProps {
  ...
  activeNav: 'plugins' | 'automations' | 'im-gateway' | 'providers' | 'skills' | 'memory' | 'snapshots' | 'policy' | 'browser' | 'rag' | 'tasks' | 'documents' | 'activity' | 'workspace' | 'projects' | 'settings' | null
  onOpenPlugins: () => void
