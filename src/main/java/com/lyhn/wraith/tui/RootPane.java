...
import com.lyhn.wraith.tui.pane.CenterPane;
import com.lyhn.wraith.tui.pane.FileTreePane;
import com.lyhn.wraith.tui.pane.InputBar;
import com.lyhn.wraith.tui.pane.StatusPane;
...
public class RootPane extends Panel {
    ...
    private final WraithConfig config;
     ...
     */
    public RootPane(WraithConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 " + com.lyhn.wraith.config.ConfigPathDisplay.path("history") + "。");
            return true;
        }
